    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="relative mx-auto max-w-5xl rounded-3xl border border-[var(--border-color)] bg-[var(--bg-primary)] p-6 shadow-2xl overflow-hidden h-[400px] md:h-[600px] flex flex-col">
              {/* Abstract Chart UI */}
              <div className="flex justify-between items-center mb-8 border-b border-[var(--border-color)] pb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-[var(--text-primary)]">EUR/USD</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="aspect-square rounded-[3rem] overflow-hidden border border-[var(--border-color)] relative group">
                <img 
                  src={images.about} 
                  alt="Onyx Office" 
                ...
                {isEditing && (
                  <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center z-20 backdrop-blur-sm border-2 border-dashed border-blue-500 m-4 rounded-[2.5rem]">
                    <Upload className="text-blue-500 mb-2" size={32} />
                    <span className="text-sm font-bold text-white mb-2">Change Image</span>
                    <input 
                      type="file" 
                      accept="image/*"
                      className="absolute inset-0 opacity-0 cursor-pointer"
                      onChange={(e) => {
                        if (e.target.files?.[0]) handleImageUpload('about', e.target.files[0]);
                      }}
                    />
                  </div>
                )}
          ...
          <div className="bg-[var(--bg-primary)] rounded-[3rem] border border-[var(--border-color)] p-12 lg:p-20 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="relative hidden lg:block">
                <div className="relative z-10 mx-auto w-[300px] h-[600px] bg-black rounded-[3.5rem] border-[10px] border-[var(--bg-secondary)] shadow-2xl overflow-hidden group/app">
                  <img 
                    src={images.app} 
                    alt="App Preview" 
                  ...
                  {isEditing && (
                    <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center z-20 backdrop-blur-sm border-2 border-dashed border-blue-500 m-4 rounded-[2.5rem]">
                      ...
                      <input 
                        ...
                        className="absolute inset-0 opacity-0 cursor-pointer"
                        onChange={(e) => {
                          if (e.target.files?.[0]) handleImageUpload('app', e.target.files[0]);
                        }}
                      />
                    </div>
                  )}
