  ...
  const renderContent = () => {
    switch (title) {
      ...
      case 'Affiliate Program':
        return (
          <div className="space-y-8">
            <p className="text-gray-400 text-lg">Partner with ONYX OPTION and earn up to 50% revenue share.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 text-center">
                <div className="text-4xl font-black text-blue-500 mb-2">50%</div>
                <div className="text-sm font-bold text-white uppercase tracking-widest">Revenue Share</div>
              </div>
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 text-center">
                <div className="text-4xl font-black text-emerald-500 mb-2">Daily</div>
                <div className="text-sm font-bold text-white uppercase tracking-widest">Payouts</div>
              </div>
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 text-center">
                <div className="text-4xl font-black text-purple-500 mb-2">24/7</div>
                <div className="text-sm font-bold text-white uppercase tracking-widest">Support</div>
              </div>
            </div>
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10 text-center">
              <h3 className="text-2xl font-bold mb-4 text-white">Ready to become a partner?</h3>
              <p className="text-gray-400 mb-8 max-w-xl mx-auto">Join thousands of successful affiliates promoting the world's most advanced trading platform.</p>
              <button className="px-8 py-4 bg-white text-black font-bold rounded-xl hover:bg-gray-200 transition-colors">Apply Now</button>
            </div>
          </div>
        );
      case 'Security':
